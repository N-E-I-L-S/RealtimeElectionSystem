...
if __name__ == "__main__":
    spark = (SparkSession.builder
            ...
            #  .master("local[*]")  # Use local Spark execution with all available cores
             ...
             .config("spark.jars",
                     r"F:\\ML Projects\BDE-ETL\\realtime-voting-data-engineering\\postgresql-42.7.1.jar")  # PostgreSQL driver
    ...
    print("Trying to read from Kafka topics")
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint2") \
        .outputMode("update") \
        .start()
    ...
    #     .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint4") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint3") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint6") \
    #     .outputMode("update") \
    #     .start()
    ...
    #     .option("checkpointLocation", "F:\ML Projects\BDE-ETL\\realtime-voting-data-engineering\checkpoints\checkpoint7") \
    #     .outputMode("update") \
    #     .start()
