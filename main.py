...
def generate_candidate_data(candidate_number, total_parties):
    ...
    if response.status_code == 200:
        ...
        return {
            ...
            "candidate_name": ["Narendra Modi", "Rahul Gandhi", "Arvind Kejriwal"][candidate_number % 3],
...
if __name__ == "__main__":
    conn = psycopg2.connect("host=localhost dbname=voting user=postgres password=neil")
    cur = conn.cursor()
